...
public class GameMapHW8 extends JPanel {
        ...
        for (int y = 0; y < fieldSizeY; y++) {
            for (int x = 0; x < fieldSizeX; x++) {
                ...
                if (field[y][x] == DOT_HUMAN) {
                    ...
                    g.drawLine(x * cellWidth + DOT_PADDING, y * cellHeight +
                            DOT_PADDING, (x + 1)* cellWidth - DOT_PADDING, (y + 1) * cellHeight - DOT_PADDING);
                    g.drawLine((x + 1) * cellWidth - DOT_PADDING, y * cellHeight +
                            DOT_PADDING, x * cellWidth + DOT_PADDING, (y + 1) * cellHeight - DOT_PADDING);
//                    Рисуем овал
